...
<link href="https://fonts.googleapis.com/css2?family=Reddit+Mono:wght@200..900&display=swap" rel="stylesheet">
    ...
    <title>Chào mừng đến với NarizFastFood</title>
    <style>
      :root {
        --bg-color: #ffbf80;
        --text-color: #157332;
    ...
    <div class="containerr">
          ...
          <div class="section_policy">
            <div class="policy_item">
              ...
              <div class="policy_item_content">
                <h4>Bảo đảm hương vị</h4>
                <p>Chất lượng đã được kiểm định VSATTT</p>
              </div>
            </div>
            <!-- end policy item -->
            <div class="policy_item">
      ...
      <footer>
        ...
        <div class="copy_right">
          <p>Copyright 2024 © Nariz. Bản Quyền Thuộc Nariz</p>
        </div>
      </footer>
    </div>

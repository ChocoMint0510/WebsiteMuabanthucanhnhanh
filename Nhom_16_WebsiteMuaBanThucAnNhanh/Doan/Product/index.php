    ...
    <div class="inp-category">
        <ul class="list-choose">
            ...
            if (isset($_POST['bntSreachCategory'])) {
                // Xử lý khi người dùng chọn danh mục tìm kiếm
                $selectedCategory = $_POST['valCheckbox'];
                showCategory($selectedCategory);
            } else {
                // Hiển thị danh mục theo ID hoặc mặc định
                $selectedCategory = isset($_GET['idML']) ? $_GET['idML'] : 0;
                showCategory($selectedCategory);
            }      
            ?>
        </ul>
                  ...
                  <div class="sort-product">
                    <form action="" method="post">
                      ...
                      <select name="field" onchange="this.form.submit()">
                        ...
                        <button type="submit" name="btnSort"><a href="http://localhost/LAPTRINHPHP/DOAN_new/Doan12/Doan/Product/index2.php" style="text-decoration: none">Sắp Xếp</a></button>
                    </form>
                  </div>
                    <!--end sort-product -->
                    <hr class="hr-btSort">

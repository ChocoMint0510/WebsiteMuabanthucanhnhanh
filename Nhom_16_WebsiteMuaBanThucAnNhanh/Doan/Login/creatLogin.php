                ...
                <span id="disError">
                    <?php
                        if (isset($_POST['bnt-submit']) and $_POST['bnt-submit'] == 'Đăng Ký') {
                            ...
                            $conn = connectDB();
                            $sql = "INSERT INTO user (userName, passWord, email, isAdmin, id_role, image, disabled) VALUES ('".$user."','".$passWord."','".$email."', b'0',2,'avata_emty.png',b'0')";
                            if ($conn ->query($sql)) {
                                $codeDiscount = "HR".str_rand(6);
                                $email_to = $email;
                                $subject = "Chào Mừng Bạn Đến Với NarizFastFood";
                                $message = '
                                            <html>
                                                
                                                <img src="" width="200px" alt="">
                                                <h2>Chào Mừng Bạn Đến Với NarizFastfood</h2>
                                                <div class="content">
                                                    <p>Bạn Đã Đăng Ký Thành Công Tài Khoản Nariz Fast Food.<br>
                                                    </p>
                                ...
                                $headers = "From:bussiness.narizfastfoodhuit@gmail.com \r\n";
                                ...
                                insertNotification("Chào Mừng Bạn Đến Với NarizFastfood","Bạn đã đăng ký thành công và được tặng một mã free ship: ","$codeDiscount",$row['id_new']);
